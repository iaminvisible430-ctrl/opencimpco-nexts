...
export const CODEX_MODELS: CodexModel[] = [
  ...
  // ---------- Bazaarlink (live-tested: chat + tool calling verified) ----------
  {
    id: "bl-glm-5-3",
    name: "GLM 5.3",
    tagline: "Zhipu's flagship coder via Bazaarlink — fast, tool-native",
    tags: ["Bazaarlink", "Coding", "Tools"],
    cost: 120,
  ...
  },
  {
    ...
    tagline: "Deep reasoning for hard refactors, via Bazaarlink",
    tags: ["Bazaarlink", "Reasoning", "Refactors"],
    cost: 150,
    providerKey: "bazaarlink",
  ...
  {
    id: "bl-qwen3-coder-next",
    name: "Qwen3 Coder Next",
    tagline: "Purpose-built coding model, via Bazaarlink",
    tags: ["Bazaarlink", "Coding", "Multi-file"],
    cost: 100,
    providerKey: "bazaarlink",
  ...
  },
  {
    id: "bl-qwen3-vl-235b",
    name: "Qwen3 VL 235B",
    tagline: "Native vision — reads screenshots and mockups directly",
    tags: ["Bazaarlink", "Vision", "Screenshots"],
    cost: 130,
    providerKey: "bazaarlink",
    provider: "qwen3-vl-235b-a22b-instruct",
    thinking: true,
    tools: true,
    vision: true,
    group: "Flagship",
  ...
  {
    id: "bl-qwen37-flash-free",
    name: "Qwen3.7 Flash (Free)",
    tagline: "Free Bazaarlink workhorse for quick iterations",
    tags: ["Free", "Bazaarlink", "Fast"],
    cost: 0,
    providerKey: "bazaarlink",
    provider: "qwen/qwen3.7-flash:free",
    thinking: true,
    tools: true,
    vision: false,
    group: "Free",
